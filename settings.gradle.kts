...
include(
  ...
  ":dd-java-agent:instrumentation:jetty:jetty-appsec:jetty-appsec-10.0",
  ":dd-java-agent:instrumentation:jetty:jetty-appsec:jetty-appsec-10.0.10",
  ":dd-java-agent:instrumentation:jetty:jetty-appsec:jetty-appsec-11.0",
  ":dd-java-agent:instrumentation:jetty:jetty-appsec:jetty-appsec-11.0.10",
